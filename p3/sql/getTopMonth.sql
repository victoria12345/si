...
DROP FUNCTION IF EXISTS getTopMonth(integer, integer);

CREATE OR REPLACE FUNCTION getTopMonth(products_entrada INTEGER, importe_entrada INTEGER,
OUT Anno INTEGER,
OUT Mes INTEGER,
OUT Importe INTEGER,
...
select * from getTopMonth(19000,320000);
